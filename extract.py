...
def convert_to_images(input_file):
    images = convert_from_path(input_file, poppler_path=r'C:\Program Files\poppler-0.68.0\bin')
    image = images[0]
...
# Create extracted text from all pages
extracted_text = ""
...
for pagenum, page in enumerate(extract_pages(pdf_path)):
    ...
    extracted_text += ''.join(page_content)
